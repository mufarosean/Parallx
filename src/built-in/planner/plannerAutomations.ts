...
// ─── Schedule spec ───────────────────────────────────────────────────────────
// The form's mental model. Pure conversions to/from ICronSchedule so the UI
 ...
 * user-presentable message on invalid input — the form surfaces it inline.
 */
...
/**
 * Best-effort inverse of {@link buildCronSchedule} so the edit form reopens
 * with the friendly controls when the schedule is one we could have built.
...
/** Human-readable schedule line for automation cards. */
