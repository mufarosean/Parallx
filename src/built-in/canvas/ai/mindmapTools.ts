...
const DRAFT_SYSTEM_PROMPT =
  ...
  + 'A formula belongs in its OWN node whose label is exactly the math wrapped in $…$ (e.g. "$E[X]=\\\\mu$", backslashes JSON-escaped) — such nodes render as real LaTeX on the board. '
