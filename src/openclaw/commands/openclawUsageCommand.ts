// D2: /usage command — Show token usage statistics for this session
// Upstream: src/commands/usage.ts — usage/cost reporting
// Cross-domain: D7 (Observability) will extend this data
...
export async function tryHandleOpenclawUsageCommand(
  ...
  // Aggregate token usage from session history
