-- Migration 007 — Reclassify tx_type from cached email subjects.
--
-- Migration 005 was applied with broken content on 2026-05-08 and is now
-- a no-op on databases where it already ran. This migration re-runs the
-- correct subject-pattern reclassification so paychecks and credit-card
-- payments stop being counted as spend.
--
